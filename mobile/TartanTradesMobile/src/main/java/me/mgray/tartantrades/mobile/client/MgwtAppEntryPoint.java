...
import me.mgray.tartantrades.mobile.client.css.AppBundle;
import me.mgray.tartantrades.mobile.client.ui.LoginPanel;
...
public class MgwtAppEntryPoint implements EntryPoint {
    ...
    MGWT.applySettings(MGWTSettings.getAppSetting());
		...
		historyHandler.register(clientFactory.getPlaceController(), clientFactory.getEventBus(), new me.mgray.tartantrades.mobile.client.activities.HomePlace());
